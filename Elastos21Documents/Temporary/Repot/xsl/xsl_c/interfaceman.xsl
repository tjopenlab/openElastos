...
<xsl:template match="attributes">
    <xsl:if match="*"><h4>属  性</h4></xsl:if>
    <table class="methodtbl" cellspacing="0" cellpadding="0">
        <THEAD class="head">
            <TD width="37%" class="cell"><xsl:value-of select="/manpage/interface"/><xsl:if match="*">属  性</xsl:if></TD>
            <TD class="cell"><xsl:if match="*">描  述</xsl:if></TD>
        </THEAD>
...
<xsl:template match="parent">
    <table class="methodtbl" cellspacing="0" cellpadding="0">
        <THEAD class="head">
            <TD width="37%" class="cell"><A class="method"><xsl:attribute name="href"><xsl:value-of select="interface_url"/>.htm</xsl:attribute><xsl:value-of select="interface_name"/></A><xsl:if match="*">方  法</xsl:if></TD>
            <TD class="cell"><xsl:if match="*">描  述</xsl:if></TD>
        </THEAD>
...
<xsl:template match="self">
    <table class="methodtbl" cellspacing="0" cellpadding="0">
        <THEAD class="head">
            <TD width="37%" class="cell"><xsl:value-of select="/manpage/interface"/><xsl:if match="*">方  法</xsl:if></TD>
            <TD class="cell"><xsl:if match="*">描  述</xsl:if></TD>
        </THEAD>
        <xsl:apply-templates select="method"/>
    </table>
...
<xsl:template match="macros">
    <xsl:if match="*"><h4>宏</h4></xsl:if>
    <table class="methodtbl" cellspacing="0" cellpadding="0">
        <THEAD class="head">
            <TD width="37%" class="cell"><xsl:value-of select="/manpage/interface"/><xsl:if match="*">宏 </xsl:if></TD>
            <TD class="cell"><xsl:if match="*">描  述</xsl:if></TD>
        </THEAD>
...
<xsl:template match="constructs">
    <xsl:if match="*"><h4>构造函数</h4></xsl:if>
    <table class="methodtbl" cellspacing="0" cellpadding="0">
        <THEAD class="head">
            <TD width="37%" class="cell"><xsl:value-of select="/manpage/interface"/><xsl:if match="*">构造函数</xsl:if></TD>
            <TD class="cell"><xsl:if match="*">描  述</xsl:if></TD>
        </THEAD>
...
<xsl:template match="callbacks">
    <xsl:if match="*"><h4>回 调 事 件</h4></xsl:if>
    <table class="methodtbl" cellspacing="0" cellpadding="0">
        <THEAD class="head">
            <TD  width="37%" class="cell"><xsl:value-of select="/manpage/interface"/><xsl:if match="*">回调事件</xsl:if></TD>
            <TD class="cell"><xsl:if match="*">描  述</xsl:if></TD>
        </THEAD>
