                ...
                <TR valign="top">
                    ...
                    <xsl:choose>
                        <xsl:when test="param_default">
                            <TD> = <xsl:value-of select="param_default"/></TD>
                        </xsl:when>
                    </xsl:choose>
                </TR>
            </xsl:for-each>
...
<xsl:template match="sample_link">
    <A class='smplink'><xsl:attribute name="href"><xsl:value-of select="@url"/></xsl:attribute>Example Code and Explain</A>
</xsl:template>
