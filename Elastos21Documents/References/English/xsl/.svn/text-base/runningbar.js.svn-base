...
if (lang == "chinese"){
    document.write("<div align='center'><a class='method' href='/copyright.htm' style='font-size:75%;font-style:italic'>科泰世纪科技有限公司 版权所有 2000年--2004年</a><p></p></div>");
}
else if (lang == "KoreTide"){
    document.write("<div style='font-size:75%;font-style:italic;color:555555;text-align:center'><a class='method' href='http://www.koretide.com.cn'>科泰世纪科技有限公司</a>（技术服务: <a href='mailto:support@koretide.com.cn' class='method'>support@koretide.com.cn</a>）</div><p></p>");
}
