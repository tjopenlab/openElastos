...
if (lang == "chinese"){
    ...
    document.write("<div style='font-size:75%;font-family:times new roman;font-style:italic;color:555555;text-align:center'><a class='style1' href='http://www.koretide.com.cn'>上海科泰世纪科技有限公司</a>（技术服务: <a href='mailto:support@kortide.com.cn' class='style1'>support@kortide.com.cn</a>）</div><p></p>");
}
else if (lang == "english,KoreTide") {
    document.write("<div style='font-size:75%;font-family:times new roman;font-style:italic;color:555555;text-align:center'><a class='style1' href='http://www.koretide.com.cn'>Koretide Corp.</a> (Technical Support: <a href='mailto:support@kortide.com.cn' class='style1'>support@kortide.com.cn</a>) </div><p></p>");
}
